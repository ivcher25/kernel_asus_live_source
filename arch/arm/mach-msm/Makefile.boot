...
ifneq ($(ASUS_BUILD_PROJECT), ZB501KL)
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-720p-mtp-zb551kl-er1.dtb 
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-720p-mtp-zb551kl-er2.dtb 
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-720p-mtp-zb551kl-pr.dtb
else
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-720p-mtp-zb501kl-sr.dtb
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-720p-mtp-zb501kl-sr2.dtb
	dtb-$(CONFIG_ARCH_MSM8226)	+= msm8926-v1-720p-mtp-zb501kl-pr.dtb
endif
endif
