...
static struct tapan_priv *tapan_priv_proc;
static struct snd_soc_codec *registered_codec;
static int tapan_codec_probed = -1;  /* ASUS_BSP Ken_Cheng +++ */
#endif
/* ASUS_BSP Paul --- */
...
static ssize_t audio_debug_proc_write(struct file *filp, const char __user *buff, size_t len, loff_t *off)
{
	...
	if (strncmp(messages, "read", strlen("read")) == 0) {
		...
		printk("[Audio][codec] dump register unavailable\n");
	} else {
...
static ssize_t audio_debug_proc_read(struct file *filp, char __user *buff, size_t len, loff_t *off)
{
	...
	switch (tapan_priv_proc->mbhc.current_plug) {
...
/* ASUS_BSP Paul +++ */
	...
	tapan_codec_probed = 1;  /* ASUS_BSP Ken_Cheng +++ */
#endif
/* ASUS_BSP Paul --- */
