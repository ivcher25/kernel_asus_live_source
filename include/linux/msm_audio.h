...
//AllenCH_Lin +++
#define AUDIO_SET_SKYPE_STATE    _IOW(AUDIO_IOCTL_MAGIC, 71, void *)
#define AUDIO_GET_SKYPE_STATE    _IOR(AUDIO_IOCTL_MAGIC, 72, void *)
#define AUDIO_SET_INCALL_STATE    _IOW(AUDIO_IOCTL_MAGIC, 73, void *)
