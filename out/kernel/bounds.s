...
@ -MD kernel/.bounds.s.d /root/kernel_asus_live_source/kernel/bounds.c
@ -mlittle-endian -marm -mabi=aapcs-linux -mno-thumb-interwork
@ -mcpu=cortex-a15 -msoft-float -mfpu=vfp -auxbase-strip kernel/bounds.s -g
...
foo:
	.fnstart
.LFB1:
	.file 1 "/root/kernel_asus_live_source/kernel/bounds.c"
	.loc 1 15 0
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	.loc 1 17 0
@ 17 "/root/kernel_asus_live_source/kernel/bounds.c" 1
	
->NR_PAGEFLAGS #23 __NR_PAGEFLAGS	@
@ 0 "" 2
	.loc 1 18 0
@ 18 "/root/kernel_asus_live_source/kernel/bounds.c" 1
	
->MAX_NR_ZONES #3 __MAX_NR_ZONES	@
@ 0 "" 2
	.loc 1 19 0
@ 19 "/root/kernel_asus_live_source/kernel/bounds.c" 1
...
.LEFDE0:
	.text
.Letext0:
	.file 2 "/root/kernel_asus_live_source/include/linux/page-flags.h"
	.file 3 "/root/kernel_asus_live_source/include/linux/mmzone.h"
	.file 4 "/root/kernel_asus_live_source/include/linux/page_cgroup.h"
...
.LASF41:
	.ascii	"zone_type\000"
.LASF51:
	.ascii	"/root/kernel_asus_live_source/kernel/bounds.c\000"
.LASF7:
	.ascii	"long unsigned int\000"
.LASF3:
	.ascii	"short unsigned int\000"
