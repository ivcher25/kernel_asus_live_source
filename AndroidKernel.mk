...
DTS_FILES += $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8926-v1-720p-mtp-zb551kl*.dts)
else
DTS_FILES += $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8926-v1-720p-mtp-zb501kl*.dts)
endif
# --- ASUS_BSP
...
$(TARGET_PREBUILT_INT_KERNEL): $(KERNEL_OUT) $(KERNEL_CONFIG) $(KERNEL_HEADERS_INSTALL)
	$(MAKE) -C kernel O=../$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=arm-linux-androideabi- $(PRODUCT_KERNEL_FLAGS)
	$(MAKE) -C kernel O=../$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=arm-linux-androideabi- $(PRODUCT_KERNEL_FLAGS) modules
